class CompetitionsController < ApplicationController
  ...
  def index
    @competitions = Competition.where(user_id: current_user.id).order(:active, :name)
  end
  ...
  private
    ...
    def competition_params
      params.require(:competition).permit(:name, :user_id, :team_category_id, :scoring_system_id, :public, :active, :prizes)
    end
end
